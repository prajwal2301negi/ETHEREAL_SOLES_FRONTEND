...
const Footer = () => {
  return (
    <footer className="bg-black pt-8 pb-4 px-12 ">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
        <div className="mb-4 md:mb-0">
          <h2 className="text-lg text-white font-bold">STEP SNEAKER</h2>
          <p className="text-white">© 2024 STEP SNEAKER. All rights reserved.</p>
        </div>
